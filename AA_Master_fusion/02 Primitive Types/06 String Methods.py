...
# String method to remove blank spaces at the end of a string
...
# String method to check the existence of a character or a sequence of characters, returns a boolean value
print("pro" in course_name_python)
print("abc" in course_name_python)
# String method to check if a sting does not contain a character or a sequence of characters, returns a boolean value
