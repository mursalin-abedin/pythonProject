...
print(second)
print(third)
# this is the same as the code in lines 6, 7, 8. The number of item in the left side of = most be the same as th
# number of items in the lis.

# If we have alist with a lot of item, and we just want to unpack the first two item and pack the rest os item in
# another list
